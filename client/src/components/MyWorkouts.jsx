                    ...
                    <div className="text-white w-full space-y-8">
                        {workout.map((workout, workoutIndex) => (
                                <div key={workoutIndex} className="w-full">
                                    <div className="lg:px-96 px-10 py-6 flex flex-row justify-between items-center">
                                        {/* Workout title */}
                                        ...
                                        <Link to={`/${workout._id}`} className="self-end hover:text-alloy-orange border border-alloy-orange rounded-2xl px-4 py-2">Start Workout</Link>
                                        {/* Workout exercises */}
